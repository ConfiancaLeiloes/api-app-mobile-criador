    ...
    public function detalhes_animal_cobricoes(ServerRequestInterface $request)
    {
        ...
        try {
            $query_sql = 
                ...
                if (count($retorno) <= 0) return  $resposta = json_encode(["codigo" => "4","status" => false, "message" => "Nenhum animal foi localizado!", "data" => ""]);
                $resposta = ["codigo" => "1","status" => true, "message" => "", "data" => $retorno];
